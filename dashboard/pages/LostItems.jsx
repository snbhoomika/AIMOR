...
export default function LostItems() {
  ...
  const fetchItems = async () => {
    setLoading(true);
    try {
      const response = await lostItemsService.getAll({
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600">Track and manage your lost items</p>
        </div>
        <Link to="/lost-items/create" className="btn-primary flex items-center gap-2">
      ...
      {loading ? (
        ...
        <div className="card text-center py-12">
          <PackageSearch className="w-16 h-16 mx-auto mb-4 text-gray-300" />
          ...
          <Link to="/lost-items/create" className="btn-primary">
            Report Lost Item
          </Link>
        </div>
      ) : (
                ...
                <div className="flex items-center gap-4 text-sm text-gray-500">
                  ...
                  {item.location && (
                    <span className="flex items-center gap-1">
                      ...
                      {item.location.address?.split(',')[0] || 'Location'}
                    </span>
                  )}
                </div>
